...
2. Projenizi seçin: `yfweqzjaguulxhherruj`
...
- Query adını: `AI-Cozumler-Schema-Setup` olarak adlandırın

### Adım 2: SQL Kodunu Kopyala
Aşağıdaki SQL kodunu tamamen kopyalayıp SQL Editor'e yapıştırın:
...
2. Başarılı mesajını bekleyin: ✅ **Success. No rows returned**
...
Eğer hata alırsanız:
1. **Mevcut tabloları temizle**: `DROP TABLE IF EXISTS profiles CASCADE;`
2. SQL'i tekrar çalıştır
3. RLS politikalarının aktif olduğunu kontrol et

## 4. Test Verisi (Opsiyonel)

Test için örnek tenant:
```sql
INSERT INTO tenants (name, slug, sector, subscription_plan) 
VALUES ('Test Kliniği', 'test-klinik', 'dentist', 'free');
```

---
**✅ Kurulum tamamlandığında sonraki adıma geçebiliriz!**
